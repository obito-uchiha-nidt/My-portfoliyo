/* ══ GitHub Storage — works in every browser ══
   Data lives in portfolio-data.json in your GitHub repo.
   Admin saves → GitHub updates → Netlify redeploys → everyone sees it.
   ══════════════════════════════════════════════════════ */
...
async function loadFromFirebase(defaultData) {
  try {
    // Fetch directly from raw GitHub — no auth needed, works in ALL browsers
    ...
    console.warn("GitHub fetch failed, using DEFAULT_DATA:", err.message);
    return defaultData;
  }
}

// app.js never needs to save — only admin.js saves
...
const DEFAULT_DATA = {
  profile: {
    ...
    email:"nidt845418@gmail.con", location:"San Francisco, CA",
    avatarText:"NI",
  ...
  socialLinks:[
    {id:1,label:"GitHub",  url:"https://github.com/",  visibleOnPortfolio:true},
  ...
  skills:[
    ...
    {id:5,name:"UI / UX Design", level:88,category:"Design"},
    {id:6,name:"PostgreSQL",     level:78,category:"Backend"}
  ],
  projects:[
    {id:1,title:"NovaMind AI",     description:"An AI-powered writing assistant that helps teams create better content 10x faster.",tech:["React","Python","OpenAI","Postgres"],link:"#",github:"#",color:"#c9a84c"},
    {id:2,title:"Orbit Dashboard", description:"Real-time analytics platform processing 50M+ events daily with beautiful visualizations.",tech:["Next.js","D3.js","Redis","Kafka"],  link:"#",github:"#",color:"#0EA5E9"},
    {id:3,title:"Bloom Finance",   description:"A personal finance app with smart budgeting and AI-driven spending insights.",tech:["React Native","Node.js","Plaid"],link:"#",github:"#",color:"#10B981"}
  ],
  posts:[]
};
